...
# Get URL options from application settings
settings = Settings()

config.set_section_option("alembic", "DBMS_NAME", settings.dbms_name)
config.set_section_option("alembic", "DBMS_DBAPI", settings.dbms_dbapi)

config.set_section_option("alembic", "DB_USERNAME", settings.db_username)
